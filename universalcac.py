...
BASE_PATH = {
    ...
    "cpsc2018": "/home/Yuvaraj/Documents/SHIVIN_PHD_DEEPCAC/main/programs/Multidataset/cpsc2018_processed",
...
SAVE_PATH  = f"/home/Yuvaraj/Documents/SHIVIN_PHD_DEEPCAC/main/programs/Multidataset/Afinal_results/results/{DATASET_NAME}"
MODEL_PATH = f"/home/Yuvaraj/Documents/SHIVIN_PHD_DEEPCAC/main/programs/Multidataset/Afinal_results/models/{DATASET_NAME}"
...
dcn_ldr=DataLoader(TensorDataset(Xtr_t),batch_size=128,shuffle=True)
for _ in range(20):
...
rn_ldr=DataLoader(TensorDataset(Str_t,ytr_t),batch_size=BATCH_SIZE,shuffle=True)
